...
<body>
    ...
    $sql="INSERT INTO cambios VALUES(null,
                                    '".$_POST["nombre"]."',
                                    '".$_POST["grupo"]."',
                                    '".$_POST["serie"]."',
                                    '".$_POST["imei"]."',
    ...
    echo 'CAMBIO DE SIM: '.$_POST["cambiosim"].'<br>';

    echo 'LINEA: '.$_POST["linea2"].'<br>';

    echo 'PLATAFORMA: '.$_POST["plataforma"];

    echo '<br>';
    echo '<br>';
    echo '<script type="text/javascript">alert("Cambio enviado");</script>';
