...
methods:{  
    ...
    btnAlta:async function(){                    
        ...
        preConfirm: () => {            
            return [
              ...
              this.cambio = document.getElementById('cambio').value,
              this.nombre = document.getElementById('nombre').value,
             this.stock = document.getElementById('stock').value                    
            ]
          }
        })        
        if(this.cliente == "" || this.serie == "" || this.imei =="" || this.sim == "" || this.linea == "" || this.alias ==""|| this.fecha == "" || this.plataforma == "" || this.cambio == ""|| this.nombre =="" || this.stock == 0){
                Swal.fire({
                  type: 'info',
    ...
    btnEditar:async function(id, cliente, serie, imei, sim, linea, alias, fecha, plataforma, cambio, nombre, stock){                            
        ...
        showCancelButton: true,                         
          ...
          if (result.value) {                                             
            ...
            this.editarEquipo(id,cliente,serie,imei,sim,linea,alias,fecha,plataforma,cambio,nombre,stock);
            Swal.fire(
              '¡Actualizado!',
    ...
    editarEquipo:function(id,cliente,serie,imei,sim,linea,alias,fecha,plataforma,cambio,nombre,stock){       
