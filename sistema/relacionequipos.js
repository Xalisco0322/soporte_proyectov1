...
methods:{  
    ...
    btnAlta:async function(){                    
        ...
        if(this.cliente == "" || this.serie == "" || this.imei =="" || this.sim == "" || this.linea == "" || this.alias =="" || this.plataforma == "" || this.stock == 0){
                Swal.fire({
                  type: 'info',
    ...
    btnEditar:async function(id, cliente, serie, imei, sim, linea, alias, plataforma, stock){                            
        await Swal.fire({
        title: 'EDITAR',
        html:
        ...
        showCancelButton: true,                         
          ...
          if (result.value) {                                             
            ...
            this.editarEquipo(id,cliente,serie,imei,sim,linea,alias,plataforma,stock);
            Swal.fire(
              '¡Actualizado!',
    ...
    editarEquipo:function(id,cliente,serie,imei,sim,linea,alias,plataforma,stock){       
