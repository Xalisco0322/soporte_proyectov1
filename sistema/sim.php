...
<html>
    ...
    <body>
    <header>
        <h2 class="text-center text-dark"><span class="badge badge-primary">Cambios de sim</span></h2>
    </header>    
     ...
     <div id="appEquipos">               
        <div class="container-fluid">                
            <div class="row">       
                <div class="col">        
                    <button @click="btnAlta" class="btn btn-primary" title="ALTA"><b>Agregar Cambios</b></button>
                    <br><br>
                        ...
                        <tbody>
                            <tr v-for="(equipo,indice) of equipos">                                
                                ...
                                <div class="btn-group" role="group">
                                    <button class="btn btn-secondary" title="Editar" @click="btnEditar(equipo.id, equipo.cliente, equipo.serie, equipo.imei, equipo.sim, equipo.linea, equipo.alias, equipo.fecha, equipo.plataforma, equipo.cambio, equipo.nombre, equipo.stock)"> 
    ...
    <!--Código custom -->          
    <script src="cambiosim.js"></script>         
    </body>
</html>