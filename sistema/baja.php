...
<html>
    ...
    <body>
    <header>
        <h2 class="text-center text-dark"><span class="badge badge-primary">Baja de Equipos Gateway</span></h2>
    </header>    
     ...
     <div id="appEquipos">               
        <div class="container-fluid">                
            <div class="row">       
                <div class="col">        
                    <button @click="btnAlta" class="btn btn-primary" title="ALTA"><b>Agregar Baja</b></button>
                    <br><br>
                        ...
                        <tbody>
                            <tr v-for="(equipo,indice) of equipos">                                
                                ...
                                <div class="btn-group" role="group">
                                    <button class="btn btn-secondary" title="Editar" @click="btnEditar(equipo.id, equipo.cliente, equipo.serie, equipo.imei, equipo.sim, equipo.linea, equipo.alias, equipo.fecha, equipo.plataforma, equipo.motivo, equipo.nombre, equipo.stock)"> 
    ...
    <!--Código custom -->          
    <script src="registrobaja.js"></script>         
    </body>
</html>