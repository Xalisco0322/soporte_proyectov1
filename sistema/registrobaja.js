...
methods:{  
    ...
    btnAlta:async function(){                    
        ...
        if(this.cliente == "" || this.serie == "" || this.imei =="" || this.sim == "" || this.linea == "" || this.alias ==""|| this.fecha == "" || this.plataforma == "" || this.motivo == ""|| this.nombre =="" || this.stock == 0){
                Swal.fire({
                  type: 'info',
    ...
    btnEditar:async function(id, cliente, serie, imei, sim, linea, alias, fecha, plataforma, motivo, nombre, stock){                            
        ...
        showCancelButton: true,                         
          ...
          if (result.value) {                                             
            ...
            this.editarEquipo(id,cliente,serie,imei,sim,linea,alias,fecha,plataforma,motivo,nombre,stock);
            Swal.fire(
              '¡Actualizado!',
    ...
    editarEquipo:function(id,cliente,serie,imei,sim,linea,alias,fecha,plataforma,motivo,nombre,stock){       
