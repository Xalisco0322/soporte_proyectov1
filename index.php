    ...
    <header>
     ...
     <div id="appEquipos">               
        <div class="container-fluid">                
            <div class="row">       
                <div class="col">        
                    <button @click="btnAlta" class="btn btn-success" title="ALTA"><b>Agregar Alta</b></button>
                    <br><br>
                    <a class="btn btn-success" href="#" role="button"><b>Menu</b></a>
                </div>
                 
                <div class="col text-right">                        
                    <h5>Total de Equipos: <span class="badge badge-success">{{totalStock}}</span></h5>
                </div>    
            </div>                
            <div class="row mt-5">
                <div class="col-lg-12">                    
